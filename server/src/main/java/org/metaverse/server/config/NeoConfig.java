...
/**
 * Starts embedded Neo4J with database in directory specified in org.metaverse.db
...
@Slf4j
@Configuration
@ConditionalOnProperty("org.metaverse.db")
public class NeoConfig {
  @Value("${org.metaverse.db}")
  private String dbPath;
  @Value("${org.metaverse.db.cleanup:false}")
