...
export class FloorRibbon {
  ...
  */
  ...
  /** Shows the UI */
  showUI() {
    this.recordButton = METAVERSEUI.hud.addButton("Start", "https://www.babylonjs-playground.com/textures/icons/Play.png"); // FIXME: cdn
    this.recordButton.onPointerDownObservable.add( () => this.startStopCancel());

    this.editButton = METAVERSEUI.hud.addButton("Edit","https://www.babylonjs-playground.com/textures/icons/Edit.png"); // FIXME: cdn
    this.editButton.onPointerDownObservable.add( () => this.edit());

    this.jsonButton = METAVERSEUI.hud.addButton("JSON", "https://www.babylonjs-playground.com/textures/icons/Download.png"); // FIXME: cdn
    this.jsonButton.onPointerDownObservable.add( () => this.saveJson());

    this.jsButton = METAVERSEUI.hud.addButton("JS", "https://www.babylonjs-playground.com/textures/icons/Download.png"); // FIXME: cdn
  ...
  saveJson() {
    ...
    METAVERSEUI.saveFile('FloorRibbon'+this.floorCount+'.json', json);
    this.clear();
  }
  saveJs() {
    var js = this.printJs();
    METAVERSEUI.saveFile('FloorRibbon'+this.floorCount+'.js', js);
    this.clear();
  }
  printJson() {
    var ret = '{"pathArray":\n';
