...
/**
Default progress indicator: rotating metaverse.org logo, 30 cm ahead, 5 cm below camera.
...
export class LoadProgressIndicator {
  /** Initializes MetaverseUI, loading logo geometry so it can be reused.
  ...
  constructor(scene, camera) {
    ...
    */
    ...
    var indicator = this;
    METAVERSEUI.init(scene).then( (ui) => {
