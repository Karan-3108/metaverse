import { METAVERSEUI, Avatar } from './js/metaverse-min.js';
...
export class AvatarLoader extends AvatarSelection {
  createSelection() {
    ...
    METAVERSEUI.debug = true;
    METAVERSEUI.listMatchingFiles( '../content/char/', (folders) => {
      var listed = 0;
      for ( var i = 0; i < folders.length; i++ ) {
        METAVERSEUI.listCharacters( folders[i].url(), (avatarDirs) => {
